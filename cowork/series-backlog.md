...
Add series here that you want CoWork to research. Remove them after they've been added to `series.json`.

Format: `Series Name — Author (Genre)`
...
- Dragonbone Chair (Memory, Sorrow and Thorn) — Tad Williams
