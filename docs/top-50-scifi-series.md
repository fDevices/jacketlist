...
| 4 | Ender Saga | Orson Scott Card | ✅ |
| 5 | The Hitchhiker's Guide to the Galaxy | Douglas Adams | ✅ |
| 6 | Hyperion Cantos | Dan Simmons | ✅ |
| 7 | Red Rising Saga | Pierce Brown | ✅ |
| 8 | Remembrance of Earth's Past | Liu Cixin | ✅ |
| 9 | The Culture | Iain M. Banks | ✅ |
| 10 | Murderbot Diaries | Martha Wells | ✅ |
...
| 23 | The Mars Trilogy | Kim Stanley Robinson | ✅ |
| 24 | The Book of the New Sun / Solar Cycle | Gene Wolfe | ✅ |
...
- **#8 and #21** are the same series — *Remembrance of Earth's Past* is the Chinese title; *The Three-Body Problem trilogy* is the Western marketing title. Added as one entry.
- **#14** (Robot/Empire/Foundation) overlaps with #2 (Foundation). Could be a single expanded entry or separate entries for Robot and Empire subseries.
- **#49** simplified from "Captain / Tower and Hive / Acorna-adjacent McCaffrey SF sequences" to the most recognizable McCaffrey series: *Dragonriders of Pern* (note: Pern is technically sci-fi despite fantasy aesthetics).
